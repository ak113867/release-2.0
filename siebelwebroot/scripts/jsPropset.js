...
function JSSPropertySet_Clone ()
{
   ...
   var newChild;
   var self = this;
   var childArray = self.childArray;
   var len = childArray.length;
   var propArray = self.propArray;
   ...
   for (name in propArray)
   {
       if (propArray.hasOwnProperty(name)) 
       {
           dup.SetPropertyStr (name, propArray[name]);
       }
    }
...
function JSSPropertySet_Copy (old)
{
   ...
   var newChild;
   var name;
   var axObj = this.axObj;
   var propArray = old.propArray;
   var childArray = old.childArray;
   var len = childArray.length;
   ...
   {     
      ...
      axObj.Copy(old.axObj); // this should return a value
      return (true);
   }
   ...
   for (name in propArray)
   {
       if (propArray.hasOwnProperty(name)) 
       {
      this.SetPropertyStr (name, propArray[name]);
       }
   }
