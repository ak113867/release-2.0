if( typeof( SiebelAppFacade.ClientCtrlPModel ) === "undefined" ){
    ...
    SiebelAppFacade.ClientCtrlPModel = ( function(){
        ...
        function injectAutomationAttr(ot, rn, un , ctrlInfo) {
            if(utils.IsTrue(SiebelApp.S_App.IsAutoOn())) {
                var automationInfo = CCFMiscUtil_CreatePropSet();
                automationInfo.SetType(consts.get("SWE_PST_AUTOM_INFO"));
                automationInfo.SetPropertyStr(consts.get("SWE_PROP_AUTOM_OT"), ot );
                automationInfo.SetPropertyStr(consts.get("SWE_PROP_AUTOM_RN"), rn );
                automationInfo.SetPropertyStr(consts.get("SWE_PROP_AUTOM_UN"), un );
                ctrlInfo.AddChild(automationInfo);
            }
        }
        ...
        ClientCtrlPModel.prototype.UpdateModel = function(psInfo){
            ...
            injectAutomationAttr.call(this, ctrlType, "TestEdit", "Test Edit" , ctrlTxtInfo)
            ...
            injectAutomationAttr.call(this, ctrlType, "TestChkbox", "Test Checkbox", ctrlChkboxInfo)
            ...
            injectAutomationAttr.call(this, ctrlType, "TestDateTime", "Test DateTime", ctrlDateTimeInfo)
            ...
            injectAutomationAttr.call(this, ctrlType, "TestCombo", "Test Drop Down", ctrlComboInfo)
            ...
            injectAutomationAttr.call(this, ctrlType, "TestCalc", "Test Calc" ,ctrlCalcInfo)
            ...
            injectAutomationAttr.call(this, ctrlType, "TestPhone", "Test Phone", ctrlphInfo)
            ...
            injectAutomationAttr.call(this, ctrlType, "url", "url", ctrlURLInfo)
