if (typeof(SiebelAppFacade.VHABillAccGenarateOtpAppletPR) === "undefined") {

    SiebelJS.Namespace("SiebelAppFacade.VHABillAccGenarateOtpAppletPR");
    define("siebel/custom/VHABillAccGenarateOtpAppletPR", ["siebel/jqgridrenderer"],
        function () {
        SiebelAppFacade.VHABillAccGenarateOtpAppletPR = (function () {

            function VHABillAccGenarateOtpAppletPR(pm) {
                SiebelAppFacade.VHABillAccGenarateOtpAppletPR.superclass.constructor.apply(this, arguments);
            }

            SiebelJS.Extend(VHABillAccGenarateOtpAppletPR, SiebelAppFacade.JQGridRenderer);
            var pm;
            var controls;
            ...
            VHABillAccGenarateOtpAppletPR.prototype.Init = function () {
                
                SiebelAppFacade.VHABillAccGenarateOtpAppletPR.superclass.Init.apply(this, arguments);
               
            }

            VHABillAccGenarateOtpAppletPR.prototype.ShowUI = function () {

                SiebelAppFacade.VHABillAccGenarateOtpAppletPR.superclass.ShowUI.apply(this, arguments);
            ...
            VHABillAccGenarateOtpAppletPR.prototype.BindData = function (bRefresh) {
               
                SiebelAppFacade.VHABillAccGenarateOtpAppletPR.superclass.BindData.apply(this, arguments);
                
            }

            VHABillAccGenarateOtpAppletPR.prototype.BindEvents = function () {
               
                SiebelAppFacade.VHABillAccGenarateOtpAppletPR.superclass.BindEvents.apply(this, arguments);
               
                // $('[title="test2a"]').on('click', function(){
                $('[aria-label="Contacts List Applet:Select"]').on('click', function () {
                ...
                $("#vha-cont-prof-nextbtn").on('click', function () {
                    if (verifiedStep2 === "Y") {
						...
						SiebelApp.S_App.GetActiveView().GetAppletMap()['VHA MFA BillCon Popup List Applet'].InvokeMethod('CloseApplet');
						resetMFA();
                    } else
                ...
                $("input[name=authMethod]").on("change", function () {
                    ...
                    case 'phone':
                        ...
                        if (PhnVerifyFlag_step2 === "Y" || SiebelApp.S_App.GetProfileAttr("VHANewOrg") == "Kogan") {
            ...
            VHABillAccGenarateOtpAppletPR.prototype.EndLife = function () {
                // EndLife is where we perform any required cleanup.
                // Add code here that should happen before default processing
                SiebelAppFacade.VHABillAccGenarateOtpAppletPR.superclass.EndLife.apply(this, arguments);
            ...
            function getdetails() {
			   ...
			   var app = SiebelApp.S_App.GetActiveView().GetAppletMap()['VHA MFA BillCon Popup List Applet'];
            ...
            return VHABillAccGenarateOtpAppletPR;
        }
            ());
        return "SiebelAppFacade.VHABillAccGenarateOtpAppletPR";
    })
}
