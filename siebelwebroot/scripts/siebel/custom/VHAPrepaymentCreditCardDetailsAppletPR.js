if (typeof(SiebelAppFacade.VHAPrepaymentCreditCardDetailsAppletPR) === "undefined") {
    ...
    define("siebel/custom/VHAPrepaymentCreditCardDetailsAppletPR", ["siebel/jqgridrenderer", "siebel/custom/VHABTProcessCall"], function () {
        SiebelAppFacade.VHAPrepaymentCreditCardDetailsAppletPR = (function () {
			...
			var sOrderNum = "";
			var sErrMsg = "";
			if(sView == "VHA Prepayment Processing View" || sView == "VHA Prepayment 2 Way SMS Processing View")
			{
				sOrderNum = SiebelApp.S_App.GetActiveBusObj().GetBusCompByName("VF Capture Customer Details TBC").GetFieldValue("Order Number");
			}
			if(sView == "VHA APP Prepayment Processing View" || sView == "VHA APP Prepayment 2 Way SMS Processing View")
			{
				sOrderNum = SiebelApp.S_App.GetActiveBusObj().GetBusCompByName("VHA Manage APP TBC").GetFieldValue("Order Number");
			}
			if (sOrderNum!="")			
			{
