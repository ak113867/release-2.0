if (typeof(SiebelAppFacade.VHASalesHomePageActionBarPM) === "undefined") {

 SiebelJS.Namespace("SiebelAppFacade.VHASalesHomePageActionBarPM");
 define("siebel/custom/VHASalesHomePageActionBarPM", ["siebel/pmodel"],
  function () {
   SiebelAppFacade.VHASalesHomePageActionBarPM = (function () {

    function VHASalesHomePageActionBarPM(pm) {
     SiebelAppFacade.VHASalesHomePageActionBarPM.superclass.constructor.apply(this, arguments);
    }

    SiebelJS.Extend(VHASalesHomePageActionBarPM, SiebelAppFacade.PresentationModel);

    VHASalesHomePageActionBarPM.prototype.Init = function () {
     // Init is called each time the object is initialised.
     // Add code here that should happen before default processing
     SiebelAppFacade.VHASalesHomePageActionBarPM.superclass.Init.apply(this, arguments);
     this.AddMethod("InvokeMethod",PreInvokeMethod,{sequence:true,scope:this})
    }

    VHASalesHomePageActionBarPM.prototype.Setup = function (propSet) {
     // Setup is called each time the object is initialised.
     // Add code here that should happen before default processing
     SiebelAppFacade.VHASalesHomePageActionBarPM.superclass.Setup.apply(this, arguments);
	...
	if(MethodName == "LaunchUpgrade" || MethodName == "NewAPP" || MethodName == "LaunchPostpayConnection" || MethodName == "ConnectFBB" || MethodName == "EventMethodValidate" || MethodName == "TSUpgrade")
	{  
		var sProceed="Y";
		...
		if(MethodName == "EventMethodValidate"){
    ...
    return VHASalesHomePageActionBarPM;
   }()
  );
  return "SiebelAppFacade.VHASalesHomePageActionBarPM";
 })
}