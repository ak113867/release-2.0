if (typeof(SiebelAppFacade.VHACustomerDashboardViewPR) === "undefined") {
      ...
      let newDropdown = document.createElement("div");
        ...
        newDropdown.innerHTML = `
            ...
            <ul class="dropdown-content">
                <li data-action="View full customer account">View full customer account</li>
                <hr>
                <li data-action="Connect Postpay">Connect Postpaid</li>
                <li data-action="Connect Prepay">Connect Prepaid</li>
                <li data-action="Connect nbn">Connect nbn</li>
                <hr>
                <li data-action="View orders">View orders</li>
                <li data-action="Accounts/Prepaids missing">Accounts/Prepaids missing</li>
            </ul>
        `;
        ...
        console.error("Reference element with the specified ID not found!");
    }
 ...
 //$('#ContactAction2').on('change',function(e){
  ...
  //$('#LaunchButton').on('click',function(e){
		...
		var url = 'https://tpgtel-nbaa-dt1.pega.net/prweb/CRMAgentCustomAuth';
