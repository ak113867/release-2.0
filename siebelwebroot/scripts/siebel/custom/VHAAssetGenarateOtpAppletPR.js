if (typeof(SiebelAppFacade.VHAAssetGenarateOtpAppletPR) === "undefined") {

    SiebelJS.Namespace("SiebelAppFacade.VHAAssetGenarateOtpAppletPR");
    define("siebel/custom/VHAAssetGenarateOtpAppletPR", ["siebel/jqgridrenderer"],
        function () {
        SiebelAppFacade.VHAAssetGenarateOtpAppletPR = (function () {

            function VHAAssetGenarateOtpAppletPR(pm) {
                SiebelAppFacade.VHAAssetGenarateOtpAppletPR.superclass.constructor.apply(this, arguments);
            }

            SiebelJS.Extend(VHAAssetGenarateOtpAppletPR, SiebelAppFacade.JQGridRenderer);
            var pm;
            var controls;
            ...
            VHAAssetGenarateOtpAppletPR.prototype.Init = function () {
                
                SiebelAppFacade.VHAAssetGenarateOtpAppletPR.superclass.Init.apply(this, arguments);
               
            }

            VHAAssetGenarateOtpAppletPR.prototype.ShowUI = function () {

                SiebelAppFacade.VHAAssetGenarateOtpAppletPR.superclass.ShowUI.apply(this, arguments);
            ...
            VHAAssetGenarateOtpAppletPR.prototype.BindData = function (bRefresh) {
               
                SiebelAppFacade.VHAAssetGenarateOtpAppletPR.superclass.BindData.apply(this, arguments);
                
            }

            VHAAssetGenarateOtpAppletPR.prototype.BindEvents = function () {
               
                SiebelAppFacade.VHAAssetGenarateOtpAppletPR.superclass.BindEvents.apply(this, arguments);
                ...
                $("#vha-cont-prof-nextbtn").on('click', function () {
                    if (verifiedStep2 === "Y") {
						...
						SiebelApp.S_App.GetActiveView().GetAppletMap()['VHA MFA AssCon Popup List Applet'].InvokeMethod('CloseApplet');
						resetMFA();
                    } else
            ...
            VHAAssetGenarateOtpAppletPR.prototype.EndLife = function () {
                // EndLife is where we perform any required cleanup.
                // Add code here that should happen before default processing
                SiebelAppFacade.VHAAssetGenarateOtpAppletPR.superclass.EndLife.apply(this, arguments);
            ...
            function getdetails() {
			   ...
			   var app = SiebelApp.S_App.GetActiveView().GetAppletMap()['VHA MFA AssCon Popup List Applet'];
            ...
            return VHAAssetGenarateOtpAppletPR;
        }
            ());
        return "SiebelAppFacade.VHAAssetGenarateOtpAppletPR";
    })
}
